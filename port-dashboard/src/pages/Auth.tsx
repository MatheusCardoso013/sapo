        ...
        <div className="min-h-screen flex overflow-hidden bg-white dark:bg-gray-900">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-700 relative overflow-hidden">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-300/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-lg font-medium">Dashboard em tempo real</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/30">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="text-lg font-medium">Relatórios e análises avançadas</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/30">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="text-lg font-medium">Segurança de dados garantida</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-900 relative">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="lg:hidden text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Sistema de Gestão Portuária</p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-10 border border-gray-100 dark:border-gray-700">
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-base">Acesse sua conta para continuar</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-gray-600 dark:text-gray-400 font-medium">Lembrar-me</span>
                                </label>
                                <a href="#" className="text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 font-semibold">
                                    Esqueceu a senha?
                                </a>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-lg font-medium">Configuração rápida e fácil</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm border border-white/30">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <span className="text-lg font-medium">Acesso completo às funcionalidades</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full max-w-md py-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-10 border border-gray-100 dark:border-gray-700">
                        <div className="mb-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-base">Preencha os dados para começar</p>
                        </div>
